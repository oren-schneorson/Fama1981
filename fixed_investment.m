...
lib_fi = fullfile(lib_data, 'fixed_investment');  % fixed investment
...
%BOGZ1FA105012063A
%BOGZ1FA105012023A
grp1 = {'BOGZ1FA105012063Q', 'BOGZ1FA105012065Q', 'BOGZ1FA105012005A'};
grp2 = {'BOGZ1FA105013063A', 'BOGZ1FA105013023A'}; % nonresidential
grp3 = {'BOGZ1FU105012063A', 'BOGZ1FU105012065A'};
grp4 = {'BOGZ1FA105012023A', 'BOGZ1FA105012065A'};
grp5 = [grp2, {'BOGZ1FA105012063A', 'BOGZ1FA105012023A'}]; % nonresidential+residential


% [T.BOGZ1FU105019005A, T.NCBGFCA027N] very similar...
clf
hold on
grp = sort(grp5);
...
%plot(T.date, T{:, grp})
area(T.date, T{:, grp})
%plot(T.date, [T.BOGZ1FU105019005A, T.NCBGFCA027N])

legend(metadata.desc{ismember(metadata.series, grp)})

metadata.desc{ismember(metadata.series, grp)}
