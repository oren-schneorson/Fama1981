...
metadata
% BOGZ1FA106130001Q quarterly, nonfinancial corporate, sa
% BOGZ1FU106130001Q quarterly, nonfinancial corporate, nsa, Transactions!
% BOGZ1FU106130001A annual, nonfinancial corporate
% BOGZ1FA896130061Q quarterly, all sectors
% NCBIPAA027N annual, nonfinancial corporate

grp1 = {'BOGZ1FA106130001Q', 'BOGZ1FU106130001Q'};
% look very different, although they should be the same up to sa
% Series has no levels. from: https://www.federalreserve.gov/apps/fof/SeriesAnalyzer.aspx?s=FU106130001&t=

% B1101C1A027NBEA, nonfin corp, int paid


grp2 = {'BOGZ1FA106130001Q', 'BOGZ1FU106130001A'};
% look exactly the same


grp3 = {'BOGZ1FA106130001Q', 'BOGZ1FA896130061Q'};
grp4 = {'BOGZ1FU106130001A', 'NCBIPAA027N'};
grp5 = {'BOGZ1FA106130001Q', 'NCBIPAA027N'};
grp6 = {'BOGZ1FA106130001Q', 'B1101C1A027NBEA'};
