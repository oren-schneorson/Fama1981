...
nonresidential = {...
    'RCSNNWMVBSNNCB',...    % Structures
    'BOGZ1FL105013265Q',... % Equipment
    'NCBNIPPCCB',...        % Intellectual Property Products
    'BOGZ1FL105013865Q',... % Structures Equipment and Intellectual Property Products
    'BOGZ1FL105013365Q',... % software
    'BOGZ1FL105013465Q',... % R&D
    'BOGZ1FL105013565Q',... % entertainment
};


residential = {...
    'RCVSRNWMVBSNNCB',...   % Structures
    'BOGZ1FL105012265Q',... % Equipment
    };


clf
hold on
grp = [nonresidential(1:2), residential];
...
legend({...
    ...
    metadata.desc{ismember(metadata.series, grp(3))},...
    metadata.desc{ismember(metadata.series, grp(4))},...
    })
...
both = {...
    'ESABSNNCB',... % equpiment
    'IABSNNCB',... % Inventories Excluding IVA
    '',...
    '',...
    '',...
    '',...
